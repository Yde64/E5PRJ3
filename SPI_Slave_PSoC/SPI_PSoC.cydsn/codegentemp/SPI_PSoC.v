...
module top ;
	...
	wire [0:0] tmpOE__LED_tester_net;
	wire [0:0] tmpFB_0__LED_tester_net;
	wire [0:0] tmpIO_0__LED_tester_net;
	wire [0:0] tmpINTERRUPT_0__LED_tester_net;
	electrical [0:0] tmpSIOVREF__LED_tester_net;

	cy_psoc3_pins_v1_10
		#(.id("67ac5573-5bc1-4a1e-92aa-8d1328ad66e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_tester
		 (.oe(tmpOE__LED_tester_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_tester_net[0:0]}),
		  .io({tmpIO_0__LED_tester_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_tester_net),
		  .interrupt({tmpINTERRUPT_0__LED_tester_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_tester_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SW_tester_net;
	wire [0:0] tmpIO_0__SW_tester_net;
	wire [0:0] tmpINTERRUPT_0__SW_tester_net;
	electrical [0:0] tmpSIOVREF__SW_tester_net;

	cy_psoc3_pins_v1_10
		#(.id("ffaeb955-0da3-45e5-8622-cca0e6ffe390"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SW_tester
		 (.oe(tmpOE__SW_tester_net),
		  .y({1'b0}),
		  .fb({Net_39}),
		  .io({tmpIO_0__SW_tester_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_tester_net),
		  .interrupt({tmpINTERRUPT_0__SW_tester_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_tester_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
