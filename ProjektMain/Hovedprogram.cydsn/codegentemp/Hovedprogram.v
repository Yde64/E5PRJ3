...
module top ;
	...
	cy_clock_v1_0
		#(.id("32d2c594-1330-4efb-947d-2f33b4dfd238"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    defparam Timeout_timer.InterruptOnTC = 0;
    defparam Timeout_timer.Resolution = 8;
