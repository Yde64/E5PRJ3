...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000F14u)

/* IDMUX_IRQ Address: CYREG_IDMUX_IRQ_CTL0 Size (bytes): 8 */
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)0x48000F1Cu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000F50u)
...
uint8 CYXDATA * const CYCODE PlayerSelect__addrTable[2] = {
...
/*******************************************************************************
* Function Name: PlayerSelect_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void PlayerSelect_Set(uint8 channel)
{
	if (channel < 2)
	{
		*PlayerSelect__addrTable[channel] |= PlayerSelect__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: PlayerSelect_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void PlayerSelect_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*PlayerSelect__addrTable[channel] &= (uint8)~PlayerSelect__maskTable[channel];
	}
}
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B1_P2_U1_CFG24), 0x64040404u);
