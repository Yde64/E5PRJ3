...
module top ;
    ...
    SPI_Master_v2_50_0 SPIM_1 (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_335),
        .sdat(Net_347),
        .tx_interrupt(Net_337));
    ...
    begin : demux_1
        ...
        always @(Net_415 or Net_395)
        begin
            case (Net_395)
                1'b0:
                begin
                    tmp__demux_1_0_reg = Net_415;
                    tmp__demux_1_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_1_0_reg = 1'b0;
                    tmp__demux_1_1_reg = Net_415;
                end
            endcase
        end
        assign Net_348 = tmp__demux_1_0_reg;
        assign Net_392 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --
	...
	cy_clock_v1_0
		#(.id("86945b3d-d326-4d65-b7c7-5c533eb8879d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    defparam Timer4.InterruptOnTC = 0;
	...
	cy_clock_v1_0
		#(.id("7f383dee-c788-4630-b171-4092fac49f9b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    defparam Timer5.InterruptOnTC = 0;
